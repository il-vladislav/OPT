...
\begin{figure}[h!]
	\centering
	\includegraphics [width=0.8\textwidth] {part2/2d1.png}
	\caption{`Chuze', r = 2}
	\label{fig:2d1}
...
\begin{figure}[h!]
	\centering
		\includegraphics [width=0.8\textwidth] {part2/2d2.png}
	\caption{`Makarena', r = 2}
	\label{fig:2d2}
...
\begin{figure}[h!]
	\centering
	\includegraphics [width=0.8\textwidth] {part2/3d1.png}
	\caption{`Chuze', r = 3}
	\label{fig:3d1}
...
\begin{figure}[h!]
	\centering
	\includegraphics [width=0.80\textwidth] {part2/3d2.png}
	\caption{`Makarena', r = 1}
	\label{fig:3d2}
...
Obviously there is a situation when n-dimensional movement can be approximated in 1-dimensional world with 0 error.
